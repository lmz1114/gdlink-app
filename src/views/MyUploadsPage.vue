<template>
    <DefaultLayout>
        <template #default>
            <section class="border rounded mt-0 shadow-sm bg-white vh-100 w-100" style="padding: 1.5em">
                <div class="d-flex">
                    <svg width="2.5em" height="2.5em" viewBox="0 0 25 17" fill="none" xmlns="http://www.w3.org/2000/svg" style="vertical-align: middle; margin-left: 0px; margin-right: 10px;">
                    ...
                    <h2><strong>My Uploads</strong></h2>
                </div>
